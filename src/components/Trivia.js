...
import ULIPTrivia from "./ULIPTrivia";
                  ...
                  {item.text.map((text, idx) => {
                    return (
                      <li
                        ...
                        className={`${
                          text[0] === "@"
                            ? `list-none ml-[20px] mt-1`
                            : `list-disc list-inside indent-[-23px]`
                        } 
                  section-subtitle px-3 md:px-8 text-left lg:text-[18px] mb-4 max-w-[622px] mx-auto text-darkblue list-disc list-inside indent-[-23px] lg:indent-[-24px]`} //24px indent if font ix 18px
                      >
                        {text.split("@")}
                      </li>
                    );
          ...
          >
            ...
            {item.text.map((text, idx) => {
              return (
                <li
                  key={idx}
                  className={`${text[0]==="@" ? `list-none ml-[20px] mt-1` : `list-disc list-inside indent-[-23px]`} 
                  section-subtitle px-3 md:px-8 text-left lg:text-[18px] mb-4 max-w-[622px] mx-auto text-darkblue list-disc list-inside indent-[-23px] lg:indent-[-24px]`} //24px indent if font ix 18px 
                >
                  {text.split("@")}
                </li>
