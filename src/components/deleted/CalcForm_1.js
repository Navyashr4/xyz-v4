...
const CalcForm = () => {
  return(
    <div 
      ...
      data-aos='fade-up'
      data-aos-offset='500'>
      <form className='flex flex-col items-center space-y-12 lg:flex-row lg:justify-between lg:items-center lg:space-y-0'>
        <input 
          className='input placeholder:text-darkblue'
          type='text' 
          placeholder='Enter your hash rate'></input>
        <select
          className='select'>
        ...
        <button className='btn text-white px-8 flex justify-center lg:self-start w-[60vw] max-w-[300px]'>
          Calculate
        </button>
      </form>
      {/* text */}
