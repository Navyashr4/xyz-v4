    ...
    <section className="pt-12 lg:pt-24 mx-4 lg:mx-0">
      <div className="container mx-auto">
        <div className="text-center max-w-[758px] mx-auto mb-24">
          <p className="section-title text-white section-title md:text-3xl text-center max-w-[622px] mx-auto">
            Further resources to learn about {invType.toLowerCase()} investments
          </p>
          {resourcesArray.map((resource) => {
            return (
              <div className="section-subtitle text-center lg:text-lg mb-4 max-w-[622px] mx-auto text-blue">
                <a
                  href={resource.link}
                  target="_blank"
                  rel="norefferer"
